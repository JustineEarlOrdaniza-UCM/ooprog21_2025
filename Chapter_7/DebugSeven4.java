...
import java.util.*;
class DebugSeven4 // remove "public" to run on older Java version
{
...
for(int i = 0; i < stringLength; i++) //change "<=" to "<"
{
char ch = Character.toLowerCase(aString.charAt(i)); //add "." into "aStringcharAt(i))"
System.out.print(ch);
...
System.out.println("The number of LETTERS is" + numLetters);//fixed qoute 
}
}
