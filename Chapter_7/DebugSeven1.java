...
public class DebugSeven1
{
   public static void main(String[] args)
   {
      ...
      name2 = kb.nextLine(); // add () to nextLine

      System.out.print("Third name >> ");
      name3 = kb.nextLine(); // add () to nextLine

      compareNames(name1, name2); // fix method name

      compareNames(name1, name3); // fix method name
      compareNames(name2, name3); // fix method name
   }
