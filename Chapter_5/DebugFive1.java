...
public class DebugFive1
{
   public static void main(String args[])
   {
      ...
      if(usersChoice == 1 || usersChoice == 2) // change "if(usersChoice == 1 && usersChoice == 2)"
                                               // to change "if(usersChoice == 1 || usersChoice == 2)" 
      ...
      if(usersChoice == 1)  // change "if(usersChoice = 1)" to "if(usersChoice == 1)"
      bill = bill + LOW_PRICE;
      
      // change "System.out.println(Total bill is " + bill);" to "System.out.println("Total bill is " + bill);"
